class TodayTraningsController < ApplicationController
    ...
    def create
      ...
      if @today_traning.save
        redirect_to user_today_tranings_traning_new_path(@user, today_traning_day_id: @today_traning_day, traningevent_id: @traningevent, start_date: params[:start_date], start_time: params[:start_time])
      else
    ...
    def update
      ...
      if @today_traning.update_attributes!(today_traning_params)
        ...
        redirect_to user_today_tranings_traning_new_path(current_user, today_traning_day_id: @today_traning_day, traningevent_id: @traningevent, start_date: params[:start_date], start_time: params[:start_time])
      else
        flash[:danger] = "更新に失敗しました"
        redirect_to user_today_tranings_traning_newt_path(current_user, today_traning_day_id: @today_traning_day, traningevent_id: @traningevent, start_date: params[:start_date], start_time: params[:start_time])
      end
    end
