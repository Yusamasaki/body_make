class UsersController < ApplicationController
  ...
  def show
    ...
    # 落とす体重
    @now_body_weight_pull_goal_body_weight = @target_weight.now_body_weight - @target_weight.goal_body_weight
    
    # 落とす体脂肪率
    @now_bodyfat_percentage_pull_goal_bodyfat_percentage = @target_weight.now_bodyfat_percentage - @target_weight.goal_bodyfat_percentage
