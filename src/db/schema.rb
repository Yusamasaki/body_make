...
ActiveRecord::Schema.define(version: 2021_12_23_014245) do
  ...
  create_table "targetweights", force: :cascade do |t|
    ...
    t.datetime "beginning_date", default: "2022-04-22 10:43:29"
    t.datetime "target_date", default: "2022-04-23 10:43:29"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "today_exercises", force: :cascade do |t|
    t.date "start_time", default: "2022-04-22", null: false
