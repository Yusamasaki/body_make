...
ActiveRecord::Schema.define(version: 2021_10_26_000142) do
  ...
  create_table "targetweights", force: :cascade do |t|
    ...
    t.datetime "beginning_date", default: "2021-11-10 11:41:15"
    t.datetime "target_date", default: "2021-11-11 11:41:15"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "today_exercises", force: :cascade do |t|
    t.date "start_time", default: "2021-11-10", null: false
    t.datetime "exercise_time", default: "2021-11-09 15:00:00", null: false
    t.string "note"
    t.bigint "exercise_category_id"
