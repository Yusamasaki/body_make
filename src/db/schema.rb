...
ActiveRecord::Schema.define(version: 2021_12_23_014245) do
  ...
  create_table "targetweights", force: :cascade do |t|
    ...
    t.datetime "beginning_date", default: "2021-12-27 10:53:28"
    t.datetime "target_date", default: "2021-12-28 10:53:28"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "today_exercises", force: :cascade do |t|
    t.date "start_time", default: "2021-12-27", null: false
