...
ActiveRecord::Schema.define(version: 2021_10_26_000142) do
  ...
  create_table "targetweights", force: :cascade do |t|
    ...
    t.datetime "beginning_date", default: "2021-12-16 08:09:10"
    t.datetime "target_date", default: "2021-12-17 08:09:10"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "today_exercises", force: :cascade do |t|
    t.date "start_time", default: "2021-12-16", null: false
